...
const goal = {
  ...
  description:
    'My Health in My Hands" signifies personal responsibility for well-being. It emphasizes proactive choices in physical and mental health management. In a complex healthcare environment, it underscores the importance of preventive measures, self-awareness, and daily decisions. Embracing this mindset empowers individuals to take control of their health journey, fostering autonomy and resilience in achieving overall well-being.',
  estimatedComplitionTime: "12 months",
  path: [
    {
      title: "Self-Assessment",
      description:
        "Start by assessing your current health status through a comprehensive check-up. This will help you understand your baseline health metrics, identify any existing health issues, and determine your starting point on your health journey.",
      practicalSteps: [
    ...
    },
    {
      title: "Goal Setting",
      description:
        "Define clear and specific health goals based on the assessment. Your goals should be measurable, achievable, and tailored to your unique health needs and aspirations.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Begin your journey by acquiring knowledge about health through books, courses, and online resources. Understanding the science behind health and wellness can empower you to make informed choices.",
      practicalSteps: [
    ...
    },
    {
      title: "Nutrition",
      description:
        "Consult a registered dietitian to create a personalized nutrition plan and implement healthy eating habits. Proper nutrition is fundamental to your overall health and well-being.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Develop a regular exercise routine that aligns with your health goals. Exercise is vital for physical fitness, strength, and overall well-being.",
      practicalSteps: [
    ...
    },
    {
      title: "Mental Health",
      description:
        "Focus on mental well-being through mindfulness practices, therapy, and self-care. A healthy mind is essential for overall health and happiness.",
      practicalSteps: [
    ...
    },
    {
      title: "Sleep",
      description:
        "Prioritize sleep by creating a conducive environment and maintaining a consistent sleep schedule. Quality sleep is crucial for physical and mental restoration.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Learn and practice stress-reduction techniques to enhance your ability to cope with life's challenges and maintain good health.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Share your health goals with friends and family to build a support system that encourages and motivates you along your journey.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Schedule follow-up appointments with healthcare professionals and specialists to monitor your progress and address any health concerns.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Use health tracking apps and devices to monitor your physical activity, nutrition, and sleep, helping you stay accountable and make data-driven decisions.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Reward yourself when you achieve milestones along your health journey, reinforcing positive behaviors and motivating continued progress.",
      practicalSteps: [
    ...
    },
    {
      title: "Stay Informed",
      description:
        "Continuously educate yourself about health-related topics to stay updated on the latest research, trends, and best practices.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Make sustainable changes that you can maintain over the long term, ensuring that your health improvements are lasting and not just temporary.",
      practicalSteps: [
    ...
    },
    {
      ...
      description:
        "Periodically reassess your goals and adjust your roadmap as needed to account for changes in your health, lifestyle, or priorities.",
      practicalSteps: [
